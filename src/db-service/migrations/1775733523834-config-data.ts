...
('botNumber', 'Numer telefonu przypisany do bota', '', 'feature'),
('smt-port', 'Numer portu serwera poczty wychodzącej', '', 'feature'),
('smt-host', 'Adres serwera obsługującego protokół SMTP', '', 'feature'),
('smt-password', 'Hasło do uwierzytelnienia konta e-mail', '', 'feature'),
('smt-user', 'Nazwa użytkownika lub adres e-mail', '', 'feature'),
('smt-from', 'Adres wyświetlany jako nadawca wiadomości', '', 'feature'),

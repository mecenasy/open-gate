...
export const toPlanEntry = (plan: SubscriptionPlan): PlanEntry => ({
  ...
  phoneNumbersIncluded: plan.phoneNumbersIncluded,
  messagesPerMonthIncluded: plan.messagesPerMonthIncluded,
  pricePerExtraMessageCents: plan.pricePerExtraMessageCents,
  phoneMonthlyCostCents: plan.phoneMonthlyCostCents,

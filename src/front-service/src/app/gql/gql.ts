...
type Documents = {
    ...
    "\n  query FeatureConfigsTab {\n    featureConfigs {\n      data {\n        key\n        description\n      }\n      status\n      message\n    }\n  }\n": typeof types.FeatureConfigsTabDocument,
    "\n  query GetFeatureConfigTab($input: GetFeatureConfigType!) {\n    featureConfig(input: $input) {\n      data {\n        key\n        value\n        description\n      }\n      status\n      message\n    }\n  }\n": typeof types.GetFeatureConfigTabDocument,
    "\n  mutation UpdateFeatureConfigTab($input: UpdateConfigType!) {\n    updateConfig(input: $input) {\n      status\n      message\n      data {\n        key\n        value\n      }\n    }\n  }\n": typeof types.UpdateFeatureConfigTabDocument,
...
const documents: Documents = {
    "\n  query FeatureConfigs {\n    featureConfigs {\n      data {\n        key\n        description\n      }\n      status\n      message\n    }\n  }\n": types.FeatureConfigsDocument,
    "\n  query GetFeatureConfig($input: GetFeatureConfigType!) {\n    featureConfig(input: $input) {\n      data {\n        key\n        value\n        description\n      }\n      status\n      message\n    }\n  }\n": types.GetFeatureConfigDocument,
    "\n  mutation UpdateFeatureConfig($input: UpdateConfigType!) {\n    updateConfig(input: $input) {\n      status\n      message\n      data {\n        key\n        value\n      }\n    }\n  }\n": types.UpdateFeatureConfigDocument,
    "\n  mutation QrReject ($challenge: String!) {\n    qrReject(challenge: $challenge) {\n      status\n    }\n  }\n": types.QrRejectDocument,
    "\n  mutation QrOption ($challenge: String!, $nonce: String!) {\n    qrOption(challenge: $challenge, nonce: $nonce)    \n  }\n": types.QrOptionDocument,
    "\n  mutation QrVerify ($challenge: String!, $data: JSON!) {\n    qrConfirm(challenge: $challenge, data: $data) {\n      status\n    }    \n  }\n": types.QrVerifyDocument,
    "\n  query FeatureConfigsTab {\n    featureConfigs {\n      data {\n        key\n        description\n      }\n      status\n      message\n    }\n  }\n": types.FeatureConfigsTabDocument,
    "\n  query GetFeatureConfigTab($input: GetFeatureConfigType!) {\n    featureConfig(input: $input) {\n      data {\n        key\n        value\n        description\n      }\n      status\n      message\n    }\n  }\n": types.GetFeatureConfigTabDocument,
    "\n  mutation UpdateFeatureConfigTab($input: UpdateConfigType!) {\n    updateConfig(input: $input) {\n      status\n      message\n      data {\n        key\n        value\n      }\n    }\n  }\n": types.UpdateFeatureConfigTabDocument,

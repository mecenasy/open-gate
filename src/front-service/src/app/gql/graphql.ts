...
export type UpdateTenantFeaturesMutation = {
  __typename?: 'Mutation';
...
export const UpdateTenantFeaturesDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
...
} as unknown as DocumentNode<UpdateTenantFeaturesMutation, UpdateTenantFeaturesMutationVariables>;

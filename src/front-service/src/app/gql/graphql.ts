...
export type FeatureConfigsQuery = {
  __typename?: 'Query';
  featureConfigs: {
    __typename?: 'ConfigsListType';
    status: boolean;
    message: string;
    data: Array<{ __typename?: 'ConfigType'; key: string; description: string }>;
  };
};
...
export type GetFeatureConfigQuery = {
  __typename?: 'Query';
  featureConfig: {
    __typename?: 'ConfigsListType';
    status: boolean;
...
export type UpdateFeatureConfigMutation = {
  __typename?: 'Mutation';
  updateConfig: {
    __typename?: 'ConfigResponseType';
    status: boolean;
  ...
  definitions: [
    {
      ...
      operation: 'query',
      name: { kind: 'Name', value: 'FeatureConfigs' },
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
          {
...
} as unknown as DocumentNode<FeatureConfigsQuery, FeatureConfigsQueryVariables>;
export const GetFeatureConfigDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'GetFeatureConfig' },
      variableDefinitions: [
        {
          ...
          type: {
            kind: 'NonNullType',
            type: { kind: 'NamedType', name: { kind: 'Name', value: 'GetFeatureConfigType' } },
          },
        },
      ],
      selectionSet: {
        ...
        selections: [
          {
            kind: 'Field',
            name: { kind: 'Name', value: 'featureConfig' },
            arguments: [
              {
                kind: 'Argument',
...
} as unknown as DocumentNode<GetFeatureConfigQuery, GetFeatureConfigQueryVariables>;
  ...
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'UpdateFeatureConfig' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'input' } },
...
} as unknown as DocumentNode<UpdateFeatureConfigMutation, UpdateFeatureConfigMutationVariables>;

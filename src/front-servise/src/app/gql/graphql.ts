...
export type GetCommandsQuery = { __typename?: 'Query', commands: { __typename?: 'CommandsListType', status: boolean, message: string, total: number, data: Array<{ __typename?: 'CommandType', id: string, name: string, description: string, active: boolean, actions: any, parameters: any, roleNames: Array<string> }> } };
...
export type AddCommandMutation = { __typename?: 'Mutation', addCommand: { __typename?: 'CommandResponseType', status: boolean, message: string, data?: { __typename?: 'CommandType', id: string, name: string, description: string, active: boolean, actions: any, parameters: any, roleNames: Array<string> } | null } };

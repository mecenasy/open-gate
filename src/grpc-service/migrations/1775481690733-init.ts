...
export class Init1775481690733 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."user_roles_usertype_enum" AS ENUM('admin', 'super_user', 'member', 'user')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."prompts_prompttype_enum" AS ENUM('admin', 'super_user', 'member', 'user')`);
        ...
        await queryRunner.query(`CREATE TABLE "configs" ("key" character varying(255) NOT NULL, "value" text NOT NULL, "description" text, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_03f58fb0f3cccd983dded221bf5" PRIMARY KEY ("key"))`);
        await queryRunner.query(`CREATE TABLE "command_permissions" ("command_id" uuid NOT NULL, "role_id" uuid NOT NULL, CONSTRAINT "PK_d5c6104040405e771ff84f4c9da" PRIMARY KEY ("command_id", "role_id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "command_permissions" ADD CONSTRAINT "FK_a01264efc002c6c819c828d9ec7" FOREIGN KEY ("command_id") REFERENCES "commands"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "command_permissions" ADD CONSTRAINT "FK_81a52697ef962764c3572a65dac" FOREIGN KEY ("role_id") REFERENCES "user_roles"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
